 ...
 */
@WebServlet(
		urlPatterns = { "/AdicionaContatoDB2" }, 
		initParams = { 
				@WebInitParam(name = "driverclassname", value = "org.apache.derby.jdbc.EmbeddedDriver"), 
				@WebInitParam(name = "dburl", value = "jdbc:derby:C:/temp/DB-DERBY"), 
